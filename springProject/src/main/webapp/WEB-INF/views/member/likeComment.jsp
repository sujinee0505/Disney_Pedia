				...
				<div class="css-bawlbm">
					<div class="css-4obf011">
						<div class="css-1cvf9dk">
							<a title="유저닉네임" class="css-1f9m1s4-StylelessLocalLink eovgsd01"
								href="/ko-KR/users/DgwxAeQYNxrMj">
								<div class="css-107z6xc">
									<div class="css-10h5a7j-ProfilePhotoImage"></div>
								</div>
						...
						<div class="css-yqs4x12">
							<img
								...
								width="16px" height="16px" alt="star"><span>평균별점 및 평가한별점</span>
						</div>
					</div>
					...
					<div class="css-1atijos">
						<span
							...
							width="18px" height="18px" class="css-q0vi8"></span>
							<em>댓글 갯수</em>
					</div>
