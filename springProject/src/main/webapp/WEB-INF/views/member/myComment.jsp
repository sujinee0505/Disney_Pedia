...
<section class="css-18gwkcr">
	<section class="css-le8j8b" style="min-height: 950px;">
		<div class="css-1jehmiq"
			...
			<div class="css-10zg79x-pageMarginStyle" style="font-weight: 700; font-size: 22px; color: black;">마이 코멘트</div>
		</div>
											...
											<li class="css-8y23cj"
												...
												<div class="css-4obf01">
													<div class="css-1cvf9dk">
														<a title="" class="css-1f9m1s4-StylelessLocalLink eovgsd01"
													...
													<div style="display: flex; justify-content: space-between; align-items: center; margin: 15px 0;">
														<div class="css-1agoci2">
															${contentsList[status.index].title}
														...
														<c:if test="${!empty commentList.star && commentList.star != 0}">
														...
														<div class="css-1g78l7j">
															<div class="css-1v2z0uj-ProfilePhotoImage">
																<img class="css-qhzw1o-StyledImg"
																	...
																	<span
																	style="overflow: hidden; text-overflow: ellipsis; -webkit-line-clamp: 3; -webkit-box-orient: vertical; margin-left: 15px;">${commentList.content}</span>
															<div class="css-1atijos" style="display: flex; justify-content: space-between; border-top:1px solid #e5e5e5; border-bottom: none; ">
															...
															<span
																...
																<em class="countLike">
																<c:if test="${commetList.countLike >0}">${commetList.countLike}</c:if>
