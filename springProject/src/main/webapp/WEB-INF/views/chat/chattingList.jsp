		      ...
		      success:function(param){
		         if(param.result == 'logout'){
		            ...
		            $(param.chattingList).each(function(index,item){
		               let output = '<div>';
		               output += '<a href="chatting.do?chatboard_num=${chatboard.chatboard_num}&trans_num='+item.from_num+'">' + item.id + '('+item.chatstate_num+')님과 대화하기</a>';
		               output += '</div>';
...
<div class="page-main-chat" id="main-chat" style="margin-top: 100px;">
	<h2>${chatboard.title}의
		작성자 <small>${chatboard.mem_num}</small>님의 채팅 목록
	</h2>
