...
<div class="page-main ">
	<form:form modelAttribute="chatboard" action="update.do"
		...
		<div>
			...
			<span class="badge rounded-pill bg-danger">모집 중!</span> <input
				type="radio" name="mate_state" value="1" id="smate_state1">
			<c:if test="${chatboard.mate_state == 1}"></c:if>
			<span class="badge rounded-pill bg-light text-dark">모집 마감</span>
		</div>
		<!-- 수정 삭제 버튼 -->
		<div class="align-center">
			<button type="button" value="등록" id="chat_modi"
				onclick="update_action()" class="btn btn-outline-primary">수정하기</button>
